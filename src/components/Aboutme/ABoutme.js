             ...
             <div className="col s8">
                 <div className="infocard  horizontal " id="infocard">
                    ...
                    <div className="card-content aboutMe" id="aboutmeParagraphs">
                             <p>My name is Dmitry Voronov. I am a full stack web developer. I build responsive dynamic web applications using Javascript, JQuery, ReactJS, Angular, NodeJS. I am also proficient with MongoDB, MySQL. I obtained developer skills through my experience as a freelancer and from George Washington Universitys' full stack developer certification course. In addition, I have a degree in Finance from George Mason University, and Business Administration degree from NVCC. One of the reasons why I chose coding is that I like to solve problems and create solutions that make peoples' life easier. I like learning new skills and pushing myself to new limits. I enjoy working on applications in teams and alone. I am proficient in developing functional web applications using Javascript and ReactJS, Angular as well as in styling web applications using CSS, Bootstrap and Materialize frameworks. 
